...
## 1.1) Branding and Language

- `NaMo`: core engine identity.
- `Dhammic Moat`: defensibility via transparent, mathematically constrained design.
- `Karuna Protocol`: privacy-aware, human-centered operational policy.
- Documentation standard: English Core, Thai Soul.
